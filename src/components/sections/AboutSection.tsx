      ...
      <div className="about-content">
        ...
        <div className="about-right">
          ...
          <div
            ...
            className={`about-resume-wrapper ${isVisible ? "is-visible" : ""}`}
          >
            <button
        ...
        <div className="about-left">
          ...
          >
            ...
            <div className="social-links-drawer">
              <a
                href="https://www.instagram.com/samjerishd"
                target="_blank"
                rel="noreferrer"
          ...
          <div className="polaroid-card">
            <div className="binder-clip">
              ...
              >
                {/* Top wire */}
                <path
                  d="M22 35 L22 15 C22 5, 38 5, 38 15 L38 35"
                  stroke="#777"
                  strokeWidth="3"
                  fill="none"
                />
                ...
                <path
                  d="M22 35 L12 60 C8 70, 52 70, 48 60 L38 35"
                  stroke="#777"
                  strokeWidth="3"
                  fill="none"
                />
            ...
            <div className="polaroid-text">
              ...
              <div className="info-section">
                ...
                <div className="info-row">
                  ...
                  <span className="value handwriting">
