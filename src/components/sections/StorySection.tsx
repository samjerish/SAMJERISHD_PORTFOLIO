            ...
            <div className="id-card-stack">
              ...
              <div className="id-card-fg">
                ...
                <div className="id-card-clip">
                  <svg width="40" height="70" viewBox="0 0 24 42" fill="none" stroke="#666666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="id-card-content">
                  ...
                  <div className="id-card-info-row">
                    ...
                    <span className="id-card-value handwriting">Sam Jerish</span>
                  </div>
                  
                  <div className="id-card-info-row">
                    <span className="id-card-label">Role:</span>
                    <span className="id-card-value handwriting">Full Stack Developer</span>
                  </div>
                </div>
              </div>
            </div>
