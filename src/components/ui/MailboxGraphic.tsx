...
export const MailboxGraphic: React.FC<MailboxGraphicProps> = ({
  isDelivering = false,
}) => {
  ...
  return (
    <div
      className={`mailbox-graphic-container ${isDelivering ? "is-delivering" : ""}`}
    >
      <div
        className={`mailbox ${isOpen ? "is-open" : ""}`}
        onClick={() => !isDelivering && setIsOpen(!isOpen)}
      >
        <div className="mailbox-post"></div>
        <div className="mailbox-body">
          <div className="mailbox-door">
            <div className="mailbox-door-front">
              <div className="mailbox-nameplate">SAM JERISH D</div>
